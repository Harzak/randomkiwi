...
public sealed class WebViewConfigurator : IWebViewConfigurator
{
    ...
    public CookieContainer? CreateCookieContainer(Uri targetUri)
    {
        ...
        string themeCode = _appConfig.CurrentTheme == AppTheme.Dark ? WikipediaWebConsts.COOKIE_THEME_CLIENT_VALUE_NIGHT : WikipediaWebConsts.COOKIE_THEME_CLIENT_VALUE_LIGHT;
